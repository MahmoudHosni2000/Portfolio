...
*/
/*
"use client" used to isolate ui component from server to raise performance and prevents conflict between 'client-side'&'server-side' while rendering
*/
"use client";
...
export default function Wizard(props) {
  ...
  useFrame((state,delta,xFrame)=>{
    ...
    modelRef.current.position.y = -1.5 + Math.sin(state.clock.elapsedTime)*0.5; // [sin() = [1,-1]]
  })
